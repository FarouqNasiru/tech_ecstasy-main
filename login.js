...
async function handleSuccessfulAuth(user) {
  ...
  } else if (redirect === 'product' && productId) {
    // Redirect to product details page
    window.location.href = `product.html?id=${productId}`;
  } else if (redirect === 'wishlist' && productId) {
    // Redirect to shop page (wishlist functionality is in shop)
    window.location.href = `shop.html?wishlist=${productId}`;
  } else {
